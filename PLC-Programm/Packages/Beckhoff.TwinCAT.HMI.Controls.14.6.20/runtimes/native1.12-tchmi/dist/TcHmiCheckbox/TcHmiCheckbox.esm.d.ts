...
declare class TcHmiCheckbox extends TcHmiControl.Control {
     ...
     */
    protected __onResolverForToggleStateIconColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForTextBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
