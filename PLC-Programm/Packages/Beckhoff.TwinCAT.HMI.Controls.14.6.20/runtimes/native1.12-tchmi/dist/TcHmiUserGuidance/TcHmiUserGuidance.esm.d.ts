...
declare class TcHmiUserGuidance extends TcHmiControl.Control {
     ...
     */
    protected __onResolverForPagesWatchCallback: (data: ObjectResolver.IWatchResultObject<Page[]>) => void;
    /**
