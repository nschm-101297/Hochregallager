...
declare class TcHmiControl extends baseTcHmiControl {
     ...
     */
    protected __onResolverForGridItemLayoutWatchCallback(data: ObjectResolver.IWatchResultObject<GridItemLayout>): void;
    /**
     ...
     */
    protected __onResolverForFlexItemLayoutWatchCallback(data: ObjectResolver.IWatchResultObject<FlexItemLayout>): void;
    /**
